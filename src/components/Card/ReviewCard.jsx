...
export const ReviewCard = ({ image, title, description, profilePic, name }) => (
    <div className='text-center carousel-focus w-[28rem] p-4 flex flex-col items-start gap-6 bg-white border border-primary-light-active rounded-lg'>
        ...
        <div className='mx-auto flex flex-col justify-start items-center gap-2'>
